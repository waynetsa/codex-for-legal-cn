...
- P1-1 侵权初筛比对优先级和方法：已修复。
- P1-2 授权审查替代表述颗粒度：已修复。
- P1-3 平台投诉材料清单：已修复。
- P2-1 权属链条宽表：已缓解，保留紧凑视图优化。
- P2-2 证据保全宽表：已缓解，保留筛选视图优化。
- P2-3 acceptance README 快速导航：已修复。

P0 为 0，P1 为 0，剩余 P2 均为可接受体验优化项。建议在验证通过后发布 `v0.2.0-alpha`。
